...
public class CountUniqueWords {
    public static void main(String[] args) {
        ...
        for(int i = 0; i < words.length; i++){    //Convert all words to lowercase
        ...
        System.out.println("There are " + uniqueWords.size() + " unique words in the text if we ignore case sensitivity.");
    }
}
